...
def changelog(repo, file_path, date_string, lines, message, tries=5, branch="master"):
	completed = 0
...
def main():
	...
	status = changelog(repo, changelog_path, date_string, pr_data, "Changelog for #{} [skip ci]".format(pr.number))
